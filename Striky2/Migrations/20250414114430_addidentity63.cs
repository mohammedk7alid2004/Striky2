...
{
    /// <inheritdoc />
    public partial class addidentity63 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CountExercises = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercies_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Count = table.Column<int>(type: "int", nullable: true),
                    Douration = table.Column<int>(type: "int", nullable: true),
                    Vedo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExerciseId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciesDetails", x => x.ExerciseDetailId);
                    table.ForeignKey(
                        name: "FK_ExerciesDetails_Exercies_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercies_CategoryId",
                table: "Exercies",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ExerciesDetails_ExerciseId",
                table: "ExerciesDetails",
                column: "ExerciseId");
